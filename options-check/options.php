...
function optionsframework_options() {
	...
	$options[] = array(
		...
		$options[] = array(
			'name' => __('Input Text Mini2', 'options_check'),
			'desc' => __('A mini2 text input field.', 'options_check'),
			'id' => 'example_text_mini',
			'std' => 'my new text field',
			'class' => 'mini',
			'type' => 'text');
...
$options[] = array(
	'name' => __('footer_image', 'options_check'),
	'desc' => __('from here we add image in the footer', 'options_check'),
	'id' => 'footerimage_uploader',
	'type' => 'upload');


		$options[] = array(
			'name' => __('footer_content', 'options_check'),
			'desc' => __('here we add the content of footer', 'options_check'),
			'id' => 'footercontent_textarea',
			'std' => 'Default Text',
			'type' => 'textarea');

			$options[] = array(
				'name' => __('Contact_Us_Address', 'options_check'),
				'desc' => __('here we add the address', 'options_check'),
				'id' => 'address_textarea',
				'std' => 'Default Text',
				'type' => 'textarea');

				$options[] = array(
					'name' => __('Contact_Us_Phone', 'options_check'),
					'desc' => __('here we add the contact number.', 'options_check'),
					'id' => 'phone_text',
					'std' => 'Default Value',
					'type' => 'text');

					$options[] = array(
						'name' => __('Contact_Us_Email', 'options_check'),
						'desc' => __('here we add the contact email', 'options_check'),
						'id' => 'email_text',
						'std' => 'Default Value',
						'type' => 'text');

						$options[] = array(
							'name' => __('Social_Icon_Twitter', 'options_check'),
							'desc' => __('here we add the link of twitter', 'options_check'),
							'id' => 'twitter_text',
							'std' => 'Default Value',
							'type' => 'text');
							$options[] = array(
								'name' => __('Social_Icon_Facebook', 'options_check'),
								'desc' => __('here we add the link of facebook', 'options_check'),
								'id' => 'facebook_text',
								'std' => 'Default Value',
								'type' => 'text');
								$options[] = array(
									'name' => __('Social_Icon_Google+', 'options_check'),
									'desc' => __('here we add the link of google+', 'options_check'),
									'id' => 'google_text',
									'std' => 'Default Value',
									'type' => 'text');
									$options[] = array(
										'name' => __('Social_Icon_Tumblr', 'options_check'),
										'desc' => __('here we add the link of tumblr', 'options_check'),
										'id' => 'tumblr_text',
										'std' => 'Default Value',
										'type' => 'text');
