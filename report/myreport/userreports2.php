...
<input type="button" name="click" value="click" onclick="show_bar_chart_period();">
                        ...
                        <div class=" row-fluid detail_list" style="margin-top: 30px;font-size: 14px;">
                          <div class="span6"> Logins
                            ...
                            <div style="height:400px;width:600px;" id="ChartContainer">
                       ...
                       datasets: [
                           ...
                           },
                           {
                               ...
                               foreach ($times as $value) {
                                 $date1= $value[0];
                                 $date2= $value[1];
                                 $count_courses_completed_by_user_between_two_date=count_courses_completed_by_user_between_two_date($date1,$date2,$uid);
                                 echo $count_courses_completed_by_user_between_two_date->count_course;
                                 echo ",";
                               }
