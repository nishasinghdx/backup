...
function optionsframework_options() {
	...
	$options[] = array(
		...
		$options[] = array(
			...
			'desc' => __('Add facebook link here', 'options_check'),
			'id' => 'facebook_link',
			'std' => 'Default value',
			'type' => 'text');
			...
			$options[] = array(
				...
				'desc' => __('Add twitter link here', 'options_check'),
				'id' => 'twitter_link',
				'std' => 'Default value',
				'type' => 'text');
				...
				$options[] = array(
					...
					'desc' => __('Add instagram link here', 'options_check'),
					'id' => 'instagram_link',
					'std' => 'Default value',
					'type' => 'text');
					...
					$options[] = array(
						...
						'desc' => __('Add youtube link here', 'options_check'),
						'id' => 'youtube_link',
						'std' => 'Default value',
						'type' => 'text');

						$options[] = array(
							'name' => __('Apple Link', 'options_check'),
							'desc' => __('Add apple link here', 'options_check'),
							'id' => 'apple_link',
							'std' => 'Default value',
							'type' => 'text');

							$options[] = array(
								'name' => __('Futurity Link', 'options_check'),
								'desc' => __('Add futurity link here', 'options_check'),
								'id' => 'futurity_link',
								'std' => 'Default value',
								'type' => 'text');

								$options[] = array(
									'name' => __('Youku Link', 'options_check'),
									'desc' => __('Add youku link here', 'options_check'),
									'id' => 'youku_link',
									'std' => 'Default value',
									'type' => 'text');
									...
									$options[] = array(
										...
										'desc' => __('Add contact us address here', 'options_check'),
										'id' => 'address',
										'std' => 'Default Text',
										'type' => 'textarea');
										...
										$options[] = array(
											...
											'desc' => __('Add Footer logo here', 'options_check'),
											'id' => 'footer_logo',
											'type' => 'upload');
