...
@media only screen and (max-width: 767px){
.nav-collapse #sitesearch{
  display: none!important;
}
}
@media (min-width: 768px){
body#alumni_main .page .module.uchicago-events span.date, body#home.new .page .module.uchicago-events span.date{
    width: 90px!important;
    height: 90px!important;
}
}
body#alumni_main .page .module.uchicago-events h2, body#home.new .page .module.uchicago-events h2{
...
<!-- top nav bar ends here -->
					<div class="row-fluid wordmark" aria-label="wordmark" role="navigation">
						<a href="http://braxtoncollege.com" style="background-image: url('<?php echo $logo_url[0];?>');">
    ...
    <ul id="features_container">
        ...
        <li class="first">
            <a href="<?php the_field('slider_link'); ?>" class="herowrap">
                ...
                <div class="slidewrap">
                    <div class="headline">
                        <span class="slider_title"><?php echo get_the_title(); ?></span>
