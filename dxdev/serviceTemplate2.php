...
<meta property="og:image" content="http://www.designersx.com/wp-content/themes/dxdev/img/logo%20-%20website.jpg" />
...
<?php
    ...
    if(isset($PageData['ChatScript'])){
      echo '<script src="'.$PageData['ChatScript'][0].'"></script>';
    }
   ?>
...
<div class="salesforceCover salesforceCoverbackground">
      ...
      <img src="<?php if(isset($PageData['ServicePageHeaderImageUrl'])) { print_r($PageData['ServicePageHeaderImageUrl'][0]); } ?>" alt="" height="200"/>
      ...
      if(isset($Attachments['ServicePageBannerCloudImage'])) {
        ...
        <img src="<?php echo $image; ?>" class="cloudImg" alt="" <?php
   ...
   <section class="body_container" role="main">
      ...
      <div class="medium-4 large-4 columns text-center keyPoints"><?php echo the_post_thumbnail( array(120, 120),array( 'title' => get_the_title(),'alt' =>get_the_title()) );?>
    ...
    <?php
      ...
      ?>
        ...
        <div class="tab">
          ...
          <p><?php echo the_excerpt(); ?></p>
          <div class="image-block"><?php echo the_post_thumbnail( 'full',array('alt' => get_the_title() ));?></div>
          </div>
        </li>
...
.mod .image-loader {
 background: url(<?php if(isset($Attachments['ServicePageLoaderImage'])) { print_r($Attachments['ServicePageLoaderImage'][0]); }?>) 50% no-repeat;
}
