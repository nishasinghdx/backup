...
padding: 4px 0 10px; text-align: center;
			...
			<div class="main">
				...
				<iframe width="602" height="340" src="<?php  echo $meta['video']; ?>?enablejsapi=1&amp;wmode=transparent&amp;feature=oembed&amp;hd=1&amp;rel=0&amp;autohide=1&amp;showinfo=0"  ></iframe>
					...
					<div class="post-cnt">
						...
						?>
							<li class="custom-pad"><span><img src="<?php bloginfo('template_directory'); ?>/images/check_01.png" alt="bullet" /></span><?php  echo $service['serv']; ?></li>
						...
						<div class="custom-wid">
							<input id="mainemail" class="form-control" type="text"  placeholder="Enter Your Email Address Here" onblur="firstname1();" name="fname">
							<a href="javascript:getemail();" ><img src="http://www.designersx.com/wp-content/themes/dxdev/images/add-email_get-consultation.png" alt="Get Free Consultation"  /> </a><br/>
							<span class="custom-col">We will get back to your for your project in 24 hours</span>

							<a href="#myModal" data-toggle="modal" onclick="captch1();" id="pop" class="custom-closenone"><img src="http://www.designersx.com/wp-content/themes/dxdev/images/add-email_get-consultation.png" alt="Get Free Consultation"  /> </a>
...
<div class="contacttext_f1"><img src="<?php bloginfo('template_directory'); ?>/images/ajax-loader.gif" alt="loader" /></div>
	...
	<div class="form-group custom-frombot">
        ...
        id="Poverview" onkeypress="return textareacheck(event);" placeholder="Project Overview" class="cumtom-pove" ></textarea>
