...
$childcats= get_categories('child_of=4');
              ...
              <article class="post-holder">
                <div>
                  <div class="date"> <span class="day"> <?php the_time('j') ?></span> <span class="month"><?php the_time('F') ?></span> </div>
					...
					<div class="post-meta">
					<div class="fleft">
						<i class="icon-user"></i>  <i class="icon-eye-open"></i> <a href="#"><?php echo getPostViews(get_the_ID()); ?></a> <i class="icon-comments-alt"></i>
						<a href="#"> <?php comments_number( 'no Comments', 'one Comment', '% Comments' ); ?> </a> <i class="icon-tag"></i>
