  ...
  $("#show11").show();
	...
	if (xmlhttp.readyState==4 && xmlhttp.status==200){
        ...
        success: function(responce){
		 ...
		 $("#show11").show();
		$("#loader11").hide();
		alert("Thanks !! Your Quote is submit Sucessfully");
         $("#close2").click();
...
<script src="http://www.designersx.com/wp-content/themes/dxdev-mobile/js/jquery.rotator.js"></script>
<script>
  $( function() {
