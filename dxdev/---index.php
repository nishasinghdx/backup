...
<style>
        ...
        <div class="row">
          <ul class="thumbnails">
		   ...
		   <li class="span3 thumbnail">
              <div class="block-thumbnail maxheight col auto"> <i class="icon-3x icon-troph"><i class="circle-border"></i></i>
	...
	<a class="link" href=" <?php  echo   $url1 =  of_get_option('url1'); ?>&amp;category=<?php   echo $title11 ; ?>">read more -</a></p>
            ...
            <li class="span3 thumbnail">
              <div class="block-thumbnail maxheight col auto"> <i class="icon-3x icon-cogd"><i class="circle-border"></i></i>
			...
			<li class="span3 thumbnail">
              <div class="block-thumbnail maxheight col auto"> <i class="icon-3x icon-rockd"><i class="circle-border"></i></i>
            ...
            <li class="span3 thumbnail">
              <div class="block-thumbnail maxheight col auto"> <i class="icon-3x icon-beake"><i class="circle-border"></i></i>
    ...
    <div id="third">
     ...
     <?php while (have_posts()) : the_post(); ?>
         <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'single-post-thumbnail' );   ?>
                 ...
                 <a href="<?php print_r($image[0]); ?>" class="prettyPhoto" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">  
				  ...
				  if(!empty($custom_fields)){	 
					...
					<?php   }	}	  ?>
					   ...
					   <span class="zoom-effect" ><a href="<?php print_r($image[0]); ?>" class="prettyPhoto"></a></span> 
     ...
     <?php while (have_posts()) : the_post(); ?>
              ...
              <li>
                <div class="overlow post-holder extra">
                 ...
                 <?php echo get_the_twitter_excerpt(); ?><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">&nbsp;&nbsp;read more -</a>
                </div>
              </li>
